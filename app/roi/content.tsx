    ...
    <main className="min-h-screen bg-[#05060b] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-[1180px] px-6 pb-16 pt-10">
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-white/45">Your Journey Starts Here</p>
        </div>

        <div className="space-y-6">
          <section className="rounded-[24px] border border-white/6 bg-white/[0.02] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-sm lg:p-8">
